...
const SubCategorysOut = () => {
  ...
  const APIGet1 = "https://back-my-wallet-render.onrender.com/chart-out";
  const APIPost = "https://back-my-wallet-render.onrender.com/chart-out-sub";
  const APIGet2 = "https://back-my-wallet-render.onrender.com/chart-out-sub";
  const body = {
      ...
      <Content>
        ...
        <form onSubmit={handleSubmit}>
          <input
            ...
            onChange={(e) => setSubCategoryOutToAPI(e.target.value)}
          />
